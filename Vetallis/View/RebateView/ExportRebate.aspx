...
<head runat="server">
    <title>VETALLIS - Export Rebate Data</title>
                ...
                <div class="section">
                    <div class="fieldSection" style="width:390px; margin-left:-195px;">
                        <div runat="server" style="position:absolute; top:20px; width:350px; height:50px;">
                            ...
                            <asp:DropDownList runat="server" ID="category" OnSelectedIndexChanged="rebateCategory" Width="180px" AutoPostBack="true">
                                <asp:ListItem Text="..."></asp:ListItem>
                                <asp:ListItem Text="For a Member in a Year"></asp:ListItem>
                                <asp:ListItem Text="For a Member in All Times"></asp:ListItem>
                                <asp:ListItem Text="For a Partner in a Year"></asp:ListItem>
                                <asp:ListItem Text="For a Partner in All Times"></asp:ListItem>
                                <asp:ListItem Text="For a Group in a Year"></asp:ListItem>
                                <asp:ListItem Text="For a Group in All Times"></asp:ListItem>
                                <asp:ListItem Text="For a Specific Year"></asp:ListItem>
                        ...
                        <!---PARTNER DIV-->
                        <div runat="server" id="partnerDiv" visible="false" style="position:absolute; top:70px; left:20px; width:350px; height:350px; overflow:scroll; border:solid 1px #d0d0d0;">
                            <asp:GridView ID="searchPartners" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID_PARTNER" DataSourceID="AllPartners">
                                <FooterStyle CssClass="GridViewFooterStyle" />
                                <RowStyle CssClass="GridViewRowStyle" />    
                                <SelectedRowStyle CssClass="GridViewSelectedRowStyle" />
                                <PagerStyle CssClass="GridViewPagerStyle" />
                            ...
                            <asp:SqlDataSource ID="AllPartners" runat="server" ConnectionString="<%$ ConnectionStrings:Conn %>" SelectCommand="SELECT * FROM [PARTNER]"></asp:SqlDataSource>
                        </div>
