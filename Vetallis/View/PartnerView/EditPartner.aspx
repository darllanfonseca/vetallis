<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPartner.aspx.cs" Inherits="Vetallis.View.PartnerView.EditPartner" %>
                ...
                <div class="section">
                    <div class="fieldSection">
                        ...
                        <div style="position: absolute; top: 20px; left: 10px; width: 370px; overflow: scroll; bottom: 30px; border: solid 1px #d0d0d0;">
                            <asp:GridView ID="searchPartners" runat="server" AllowSorting="True" OnSelectedIndexChanged="loadSelectedPartner" AutoGenerateColumns="False" DataKeyNames="ID_PARTNER" DataSourceID="Teste2">
