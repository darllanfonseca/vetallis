<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveMember.aspx.cs" Inherits="Vetallis.View.RemoveMember" %>
...
<body>
    ...
    <form id="removeMemberForm" runat="server">
        <div class="all">
            <div class="container">
                <div class="header">Note: The member won't be phisically removed from the database. Its status will be changed from "ACTIVE" to "INACTIVE".</div>
                <div class="section">
                    <div class="fieldSection">
                        ...
                        <div style="text-align: right; position: absolute; top: 125px; right: 15px; width: 150px; height: 50px;">
                            <b>Status</b>
                            <asp:TextBox runat="server" ID="status" Width="120px">
                            </asp:TextBox>
                        </div>
