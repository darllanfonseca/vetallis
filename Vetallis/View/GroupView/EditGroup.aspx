...
<body>
    ...
    <form id="chooseGroupForm" runat="server">
        <div class="all">
            <div class="container">
                <div class="header">
                    Choose a Group and add or remove members
                ...
                <div class="section">
                    <div id="fieldSection" style="position: absolute; left: 50%; margin-left: -400px; width: 800px;">
                        ...
                        <div style="position: absolute; top: 460px; left: 15px; width: 100px; height: 50px;">
                            <asp:Button Height="25px" Width="100px" Visible="false" Font-Names="Calibri" Font-Size="Medium" runat="server" ID="clearFields" OnClick="clearAllFields" Text="Clear Fields"/>
                        </div>
                        <div style="position: absolute; top: 430px; right: 40px; width: 140px; height: 50px;">
                            <asp:Button Height="25px" Width="140px" Font-Names="Calibri" Font-Size="Medium" runat="server" Text="Cancel" OnClick="returnToMainPage" />
                        </div>
                        ...
                        <div style="position: absolute; top: 480px; right: 40px; width: 140px; height: 50px;">
                            <asp:Button Height="30px" BackColor="#e3efc7" Width="140px" Font-Names="Calibri" Font-Size="Large" runat="server" ID="editGroup" Text="Edit This Group" OnClick="changeGroupForm"/>
                        </div>
                ...
                <div class="section">
                    <div class="fieldSection" style="position: absolute; left: 50%; margin-left: -500px; width: 1000px;">
                        ...
                        <div runat="server" id="secondMemberDiv" style="text-align: left; position: absolute; top: 120px; left: 15px; width: 450px; height: 50px;">
                            ...
                            <div style="position: absolute; width: 90px; left: 355px; top: 19px">
                                <asp:Button runat="server" Width="65px" ID="removeSecondMemberBtt" OnClick="removeSecondMember" Text="Remove" />
                            </div>
                            <div style="position: absolute; width: 90px; left: 421px; top: 19px">
                        ...
                        <div runat="server" id="thirdMemberDiv" visible="false" style="text-align: left; position: absolute; top: 170px; left: 15px; width: 450px; height: 50px;">
                            ...
                            <div style="position: absolute; width: 90px; left: 355px; top: 19px">
                                <asp:Button runat="server" Width="65px" ID="removeThirdMemberBtt" OnClick="removeThirdMember" Text="Remove" />
                            </div>
                            <div runat="server" style="position: absolute; width: 90px; left: 421px; top: 19px">
                        ...
                        <div runat="server" id="fourthMemberDiv" visible="false" style="text-align: left; position: absolute; top: 220px; left: 15px; width: 450px; height: 50px;">
                            ...
                            <div style="position: absolute; width: 90px; left: 355px; top: 19px">
                                <asp:Button runat="server" Width="65px" ID="removeFourthMemberBtt" OnClick="removeFourthMember" Text="Remove" />
                            </div>
                            <div style="position: absolute; width: 90px; left: 421px; top: 19px">
                        ...
                        <div runat="server" id="fithMemberDiv" visible="false" style="text-align: left; position: absolute; top: 270px; left: 15px; width: 450px; height: 50px;">
                            ...
                            <div style="position: absolute; width: 90px; left: 355px; top: 19px">
                                <asp:Button runat="server" Width="65px" ID="removeFithMemberBtt" OnClick="removeFithMember" Text="Remove" />
                            </div>
                            <div style="position: absolute; width: 90px; left: 421px; top: 19px">
                        ...
                        <div runat="server" id="sixthMemberDiv" visible="false" style="text-align: left; position: absolute; top: 320px; left: 15px; width: 450px; height: 50px;">
                            ...
                            <div style="position: absolute; width: 90px; left: 355px; top: 19px">
                                <asp:Button runat="server" Width="65px" ID="removeSixthMemberBtt" OnClick="removeSixthMember" Text="Remove" />
                            </div>

                        </div>

                        <div runat="server" visible="true" id="Div6" style="position: absolute; width: 400px; height: 370px; top: 20px; left: 580px; overflow: scroll; border: solid 1px #d0d0d0;">
                        ...
                        <div style="position: absolute; top: 460px; left: 15px; width: 100px; height: 50px;">
                            <asp:Button Height="25px" Width="100px" Font-Names="Calibri" Font-Size="Medium" runat="server" ID="Button10" OnClick="clearAllFields" Text="Clear Fields"/>
                        </div>
                        <div style="position: absolute; top: 460px; right: 15px; width: 120px; height: 50px;">
                            <asp:Button Height="25px" Width="120px" Font-Names="Calibri" Font-Size="Medium" runat="server" ID="Button11" Text="Cancel" OnClick="returnToMainPage" />
                        </div>
                        <div style="position: absolute; text-align: left; top: 510px; left: 15px; width: 600px; height: 50px; color: red;">
                        ...
                        <div style="position: absolute; top: 510px; right: 15px; width: 120px; height: 50px;">
                            <asp:Button Height="30px" BackColor="#e3efc7" Width="120px" Font-Names="Calibri" Font-Size="Large" runat="server" Text="Update Group" OnClick="updateGroup"/>
                        </div>
